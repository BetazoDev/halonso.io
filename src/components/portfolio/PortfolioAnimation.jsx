...
const tabList = ["All", "Web Development", "Web Design"];
const tabListContent = [
  {
    porftoliItems: [
      {
        img: "img/portfolio/Blake-portfolio.jpg",
        width: 400,
        height: 550,
        title: "Blake Electric Inc",
        subTitle: "Website build",
        alterText: "Blake Electric Inc Logo",
        delayAnimation: "",
        portfolioLink:
          "https://www.blakeelectricinc.com/",
      },
      {
        img: "/img/portfolio/parham-portfolio.png",
        width: 400,
        height: 400,
        title: "Parham Group",
        subTitle: "Website build",
        alterText: "Parham Group Logo",
        delayAnimation: "100",
        portfolioLink:
          "https://parhamgroupdev.wpengine.com/",
      },
      {
        img: "/img/portfolio/KHS-portfolio.jpg",
        width: 400,
        height: 700,
        title: "KHS The Salon",
        subTitle: "Website build",
        ...
        delayAnimation: "200",
        portfolioLink:
          "https://khsthesalon.com/",
      },
      {
        img: "/img/portfolio/CAOE-portfolio.jpg",
        width: 400,
        height: 400,
        title: "Community Action of Etowah County",
        subTitle: "Website build",
        alterText: "CAOEC Logo",
        delayAnimation: "0",
        portfolioLink:
          "https://www.communityaction-etowah.org/",
      },
      {
        img: "/img/portfolio/Brand-retro-portfolio.jpg",
        width: 400,
        height: 700,
        title: "Brand Retro Podcast",
        subTitle: "Website build",
        alterText: "Brand Retro Logo",
        delayAnimation: "100",
        portfolioLink:
          "https://www.brandretro.com/",
      },
      {
        img: "/img/portfolio/MAK-portfolio.jpg",
        width: 400,
        height: 500,
        title: "Mak Construction",
        subTitle: "Website build",
        alterText: "Mak Construction Logo",
        delayAnimation: "200",
        portfolioLink:
          "https://www.makconstructiongf.com/",
      },
      {
        img: "/img/portfolio/canabe-color-expert-portfolio.jpg",
        width: 400,
        height: 700,
        title: "Canabe Color Expert",
        subTitle: "Graphicriver Market",
        alterText: "Business Card",
        delayAnimation: "0",
        portfolioLink:
          "https://canabecolorexpert.com/",
      },
      {
        img: "/img/portfolio/ryw-portfolio.png",
        width: 400,
        height: 550,
      ...
      {
        img: "/img/portfolio/mgc-favcon.png",
        width: 400,
        height: 400,
        title: "Web Motion",
